...
class InvalidNamedConstructorArgsTest {
  ...
  void noMatchingConstructorArgName() {
    ...
    then(caughtException()).isInstanceOf(BuilderException.class).hasMessageContaining(
        ...
        .hasMessageContaining("'org.apache.ibatis.submitted.named_constructor_args.UserInfo'")
  ...
  void wrongJavaType() {
    ...
    then(caughtException()).isInstanceOf(BuilderException.class).hasMessageContaining(
        ...
        .hasMessageContaining("'org.apache.ibatis.submitted.named_constructor_args.UserInfo'").hasMessageContaining("[id]");
  }
